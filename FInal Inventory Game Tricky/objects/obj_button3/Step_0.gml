...
if (obj3Found) {
   ...
   // show_debug_message("occupied: " + string(occupied));

//show_debug_message(obj_1.visible)
//show_debug_message(obj_2.visible)
//if(instance_exists(obj_4)) show_debug_message(obj_4.visible)
